...
using UnityEngine;
using static PL_Model4;

public class PL_Model4
{
    ...
    public void ImFaceMaker(int Number)
    {
        CubeColor newCubeColor = new CubeColor();

        switch (Number) {

            case 1:
                newCubeColor = State[(int)Face.Front, 1, 1];
                State[(int)Face.Front, 1, 1] = State[(int)Face.Down, 1, 1];
                State[(int)Face.Down, 1, 1] = newCubeColor;
                break;

            case 2:
                newCubeColor = State[(int)Face.Left, 1, 1];
                State[(int)Face.Left, 1, 1] = State[(int)Face.Down, 1, 1];
                State[(int)Face.Down, 1, 1] = newCubeColor;
                break;

            case 3:
                newCubeColor = State[(int)Face.Down, 1, 1];
                State[(int)Face.Down, 1, 1] = State[(int)Face.Up, 1, 1];
                State[(int)Face.Up, 1, 1] = newCubeColor;
                break;

            case 4:
                newCubeColor = State[(int)Face.Front, 1, 1];
                State[(int)Face.Front, 1, 1] = State[(int)Face.Left, 1, 1];
                State[(int)Face.Left, 1, 1] = newCubeColor;
                break;

            case 5:
                newCubeColor = State[(int)Face.Left, 1, 1];
                State[(int)Face.Left, 1, 1] = State[(int)Face.Back, 1, 1];
                State[(int)Face.Back, 1, 1] = newCubeColor;
                break;

            case 6:
                newCubeColor = State[(int)Face.Front, 1, 1];
                State[(int)Face.Front, 1, 1] = State[(int)Face.Back, 1, 1];
                State[(int)Face.Back, 1, 1] = newCubeColor;
                break;

            case 7:
                newCubeColor = State[(int)Face.Back, 1, 1];
                State[(int)Face.Back, 1, 1] = State[(int)Face.Down, 1, 1];
                State[(int)Face.Down, 1, 1] = newCubeColor;
                break;

            case 8:
                newCubeColor = State[(int)Face.Front, 1, 1];
                State[(int)Face.Front, 1, 1] = State[(int)Face.Right, 1, 1];
                State[(int)Face.Right, 1, 1] = newCubeColor;
                break;

            case 9:
                newCubeColor = State[(int)Face.Right, 1, 1];
                State[(int)Face.Right, 1, 1] = State[(int)Face.Down, 1, 1];
                State[(int)Face.Down, 1, 1] = newCubeColor;
                break;
        }
    ...
    public void ImFaceMaker2(int Number)
    {
